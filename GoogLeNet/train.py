...
from model import GoogLeNet, Inception, AuxiliaryClassifier
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, (inputs, labels) in enumerate(train_dataloader):
            ...
            if model.aux_logits:
                ...
                # Weighted combination of losses (original paper uses 0.3 weight for aux losses)
                loss = main_loss + 0.3 * aux1_loss + 0.3 * aux2_loss
                pre_lab = torch.argmax(main_output, dim=1)
            else:
